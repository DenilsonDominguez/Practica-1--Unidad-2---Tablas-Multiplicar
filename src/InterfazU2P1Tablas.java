 ...
 * @author user
 */
public class InterfazU2P1Tablas extends javax.swing.JFrame {

    /**
     * Creates new form InterfazU2P1Tablas
     */
    public InterfazU2P1Tablas() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ingrese un numero para obtener sus valores de multiplicacion del 1 al 10");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazU2P1Tablas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazU2P1Tablas().setVisible(true);
            }
        });
    }
